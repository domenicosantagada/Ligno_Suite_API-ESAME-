...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Fondamentale: non usiamo i cookie di sessione, usiamo solo il token
                ...
                // Aggiungiamo il nostro filtro prima di quelli standard di Spring
                .addFilterBefore(jwtFilter, UsernamePasswordAuthenticationFilter.class);

        return http.build();
    }

    // Gestione GLOBALE del CORS (così puoi rimuovere @CrossOrigin dai Controller)
    @Bean
